...
import { useConfigs } from "@/hooks/config/useConfigs"; // Đổi từ useConfigOne sang useConfigs
...
export default function ContactPage() {
  ...
  // Sử dụng useConfigs thay vì useConfigOne
  const { data: configsData, isLoading } = useConfigs({
    page: 1,
    limit: 1, // Chỉ lấy 1 phần tử
    search: ''
  });
  
  // Lấy phần tử đầu tiên từ dữ liệu trả về
  const config = configsData?.data?.[0] || null;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-24">
              ...
              <div className="relative z-10">
                ...
                <Form
                  ...
                  initialValues={{
                    name: "",
                    email: "",
                    phone: "", // Đổi từ mobile sang phone
                    message: "",
                  }}
                >
                  <Form.Item
          ...
          <div className="space-y-6">
            {isLoading ? (
              ...
              <div className="bg-white rounded-2xl border-2 border-gray-100 shadow-lg p-8 text-center">
                <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <ShopOutlined className="text-gray-400 text-2xl" />
                </div>
                <Text className="text-gray-500">Chưa có cấu hình thông tin liên hệ</Text>
                <Text className="text-gray-400 text-sm mt-2 block">
                  Vui lòng thêm cấu hình trong trang quản trị
                </Text>
              </div>
            )}
          </div>
